...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  // AI Parameters
  const [aiModel, setAiModel] = useState<string>(settings.aiModel || 'gemini-3.6-flash');
            ...
            <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-3">
              ...
              >
                <optgroup label="Google Gemini Free API">
                  <option value="gemini-3.6-flash">Gemini 3.6 Flash (Recommended - Current Stable Flagship)</option>
                  <option value="gemini-3.5-flash">Gemini 3.5 Flash (Multimodal & High Speed)</option>
